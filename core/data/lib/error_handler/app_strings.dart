class AppStrings {
  ...
  static const String badRequest = "bad_request"; // todo handle localization to support many langs.
  ...
  static const String defaultError = "default_error"; // something went wrong try again later (english/turkish)
}